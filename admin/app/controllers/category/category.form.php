...
?>                                        <form action="" method="post" class="form-horizontal fill-up validatable">
                                            <div class="padded">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <?php $Category->input("name", array("data-prompt-position" => "topLeft")); ?>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label"><?php elabel("link"); ?></label>
                                                    <div class="controls">
                                                        <input type="text" name="ref" id="category-ref" class="url_slug mode-<?php echo $Category->FormMode; ?>" value="<?php echo $Category->ref; ?>" />
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span2">
                                                            <?php $Category->input("status", array("id" => "status_1", "value" => "1", "class" => "icheck")); ?>
                                                            <label for="status_1"><i class="icon-ok"></i> <?php _e("active"); ?></label>
                                                        </div>
                                                        <div class="span2">
                                                            <?php $Category->input("status", array("id" => "status_0", "value" => "0", "class" => "icheck")); ?>
