...
$upload_dir = '/downloads-img/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../downloads-img/'; // relative path from filemanager folder to upload folder (with final /)
