<?php
        require_once $basepath."../../../../../../config/config.conf.php";
	...
	$mcImageManagerConfig['filesystem.rootpath'] = THE_ROOT.'images/'; // absolute or relative from this script path, required.
