...
$tinybrowser['obfuscate'] = 'NurDerFCB!';
...
$tinybrowser['path']['image'] = '/downloads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/downloads/media/'; // Media files location
$tinybrowser['path']['file']  = '/downloads/catalogos/'; // Other files location
