...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => THE_ROOT.'images/products/original/',
            'upload_url' => MAIN_URL.'images/products/original/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                'zoom' => array(
                    ...
                    'max_height' => 1000,
                    'jpeg_quality' => 100,
                    'upload_dir' => THE_ROOT.'images/products/zoom/',
                    'upload_url' => MAIN_URL.'images/products/zoom/'
                ),
                'resizable' => array(
                    'max_width' => 500,
                    'max_height' => 500,
                    'jpeg_quality' => 100,
                    'upload_dir' => THE_ROOT.'images/products/resizable/',
                    'upload_url' => MAIN_URL.'images/products/resizable/'
                ),
                'medium' => array(
                    'max_width' => 500,
                    'max_height' => 300,
                    'jpeg_quality' => 100,
                    'upload_dir' => THE_ROOT.'images/products/medium/',
                    'upload_url' => MAIN_URL.'images/products/medium/'
                ),
                'product' => array(
                    'max_width' => 480,
                    'max_height' => 320,
                    'jpeg_quality' => 100,
                    'upload_dir' => THE_ROOT.'images/products/product/',
                    'upload_url' => MAIN_URL.'images/products/product/'
                ),
                'listing' => array(
                    'crop' => true,
                    'max_width' => 222,
                    'max_height' => 170,
                    'jpeg_quality' => 100,
                    'upload_dir' => THE_ROOT.'images/products/listing/',
                    'upload_url' => MAIN_URL.'images/products/listing/'
                ),
                'thumbnail' => array(
                    'crop' => true,
                    'max_width' => 80,
                    'max_height' => 80,
                    'jpeg_quality' => 100,
                    'upload_dir' => THE_ROOT.'images/products/thumb/',
                    'upload_url' => MAIN_URL.'images/products/thumb/'
                )
            )
        );
